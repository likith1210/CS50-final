    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meds', to='store.manufacture')),
            ],
        ),
        migrations.CreateModel(
            name='buy',
            fields=[
                ...
                ('mid', models.ManyToManyField(blank=True, related_name='patients', to='store.medicine')),
